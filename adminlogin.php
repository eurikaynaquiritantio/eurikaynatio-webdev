<?php
/**
 * adminlogin.php — staff login. Uses a separate session key
...
<title>Admin Login | TIO Perfume Collection</title>
...
<div class="auth-page-wrap">
    <div class="auth-card">
        <h1>Admin Login</h1>
        <p class="auth-card-sub">Staff access only — manage perfume size &amp; stock status.</p>
