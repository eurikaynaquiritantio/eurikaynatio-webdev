...
try {
    ...
    echo json_encode([
        "ok" => false,
        "error" => "Could not connect to the database. Make sure MySQL is running and the 'tio_perfume' database has been imported (see schema.sql).",
    ]);
    exit;
}